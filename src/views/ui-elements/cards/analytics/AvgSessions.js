...
const AvgSessions = props => {
  ...
  return data !== null ? (
    <Card style={{position:'relative', left: '120px', width: '800px'}}>
      <CardBody>
        <Row className='pb-50'>
          <Col
            sm={{ size: 6, order: 1 }}
          ...
          >
            <div className='session-info mb-1 mb-lg-0'>
              ...
              {/* <CardText className='font-weight-bold mb-2'>Average of schools</CardText> */}
          ...
          >
            ...
            <Chart style={{position: 'relative', right: 175}} options={options} series={series} type='bar' height={200} />
          </Col>
        </Row>
        {/* <hr />
        <Row className='pt-50'>
          <Col className='mb-2' md='6' sm='12'>
            <p className='mb-50'>Ananda College {data.goal}</p>
            <Progress className='avg-session-progress mt-25' value='50' />
          </Col>
          <Col className='mb-2' md='6' sm='12'>
            <p className='mb-50'>Nalanda College {kFormatter(data.users)}</p>
            <Progress className='avg-session-progress progress-bar-warning mt-25' value='60' />
          </Col>
          <Col md='6' sm='12'>
            <p className='mb-50'>Isipathana College {data.retention}</p>
            <Progress className='avg-session-progress progress-bar-danger mt-25' value='70' />
          </Col>
          <Col md='6' sm='12'>
            <p className='mb-50'>Dharmapala College {data.duration}</p>
